...
namespace ExpressionEditor.BO
{
    public class RuleSetManager
    {
        ...
        /// <summary>
        /// Validates the given Expression and returns a list of errors if these exist
        /// </summary>
        /// <param name="Expression">The XML Expression to Validate</param>
        /// <param name="errors">The generic List of Error Objects that will be returned</param>
        ...
        public static bool IsExpressionValid(string Expression, out List<ErrorObject> errors)
        {
            ...
            try
            {
                // Creates a new RuleSet object in order not to lose the DefaultRuleSet
        ...
        /// <summary>
        /// Copies DefaultRuleSet to Clipboard
        /// </summary>
